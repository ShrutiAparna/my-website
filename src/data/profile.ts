export const profile = {
  ...
  // Update these placeholders with real profile URLs.
  github: 'https://github.com/ShrutiAparna',
  linkedin: 'https://www.linkedin.com/in/shruti-aparna',
  scholar: '',
  twitter: '',

  cv: '/cv/shruti_aparna_cv.pdf',
...
export const affiliations = [
  ...
  {
    name: 'Optics and Photonics Center (OPC), IIT Delhi',
    role: 'Research Assistant',
